var treeData = {
  ...
  var i = 0,
    duration = 750,
    root;
    var treemap = d3.tree().size([height, width]).nodeSize([150,150])
...
.call(zoom.transform, d3.zoomIdentity.translate(0, 0));
  ...
  function update(source) {
    ...
    nodeEnter
      ...
      .attr('x', -24)  // position of card
      .attr('y', -24) 
      .attr('width', 150)  // card size
      .attr('height', 150)
      .append('xhtml:div')
      .attr('class', 'nodeCard')
      .html(function(d) {
        return '<h4 style="margin: 5px;">' + d.data.name + '</h4><button style="margin: 5px;">Click</button>'
      });
